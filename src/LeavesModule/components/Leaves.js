...
const Leaves = ({
  ...
  useEffect(() => {
    if (mode == "create" || mode == "read") { setLeaveReq(Emp_code) }
  }, [mode])
  ...
  //     //   message.success("You have been uploaded successfully Attachment...")
  //     //   setTimeout(() => {
  //     //     setIsModalOpen(false);
  //     //   }, 2000);
  ...
  useEffect(() => {
    if(isfileLoader == true || isDeleteLoader == true){
              ...
              <form>
                ...
                <div>
                  ...
                  <FormInput
                    ...
                    name="FromDate"
                    type="date"
                    defaultValue={isDate[0].FromDate}
                    onChange={(e) => {
                      setDate(prevData => {
                ...
                <div className='CountryBtnBox'>
                  { }
                  <CancelButton onClick={() => setMode("read")} title="Cancel" />
                  {
                    mode == "create" ?
                  ...
                  {
                    isShow == true ?
                      <Button title="Uplaod File" onClick={showModal} /> : null
                  }
