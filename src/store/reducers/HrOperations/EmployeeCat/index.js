...
const Red_Employee_Cat = (state = initState, action) => {
    switch (action.type) {
        case GET_TRANSITION_EMPOYLEE_CAT_START:
            return {
                ...state,
                loading: action.loading,
            };
        case GET_TRANSITION_EMPOYLEE_CAT_DATA:
            return {
                ...state,
                data: action.payload,
                loading: action.loading,
            };
        case GET_TRANSITION_EMPOYLEE_CAT_SINGLE:
            return {
                ...state,
                dataSingle: action.payload,
                loading: action.loading,
            };
        case GET_TRANSITION_EMPOYLEE_CAT_END:
            return {
                ...state,
                data: action.payload,
                loading: action.loading,
