...
// HR OPERATIONS ===> GRADES
export const GET_DOWNLOAD_PARA_ACCESS_DATA = "GET_TRANSITION_GRADES_DATA";
export const GET_DOWNLOAD_PARA_ACCESS_START = "GET_TRANSITION_GRADES_START";
export const GET_DOWNLOAD_PARA_ACCESS_SINGLE = "GET_TRANSITION_GRADES_SINGLE";
export const GET_DOWNLOAD_PARA_ACCESS_END = "GET_TRANSITION_GRADES_END";
