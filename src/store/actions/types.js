...
export const SET_BALANCE_DAYS = "SET_BALANCE_DAYS";
export const APPLIED_DAYS_DATA  = "APPLIED_DAYS_DATA";
export const GET_MY_LEAVE_APPLICATION = "GET_MY_LEAVE_APPLICATION";
