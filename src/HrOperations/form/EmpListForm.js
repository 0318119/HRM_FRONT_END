                                    ...
                                    switch (checkType.type) {
                                        case 'text':
                                            return <div className="form-group mt-3">
                                                ...
                                                <input type="text" name={checkType?.name} className="form-control inputtext" required
                                                    onChange={(e) => {
                                        ...
                                        case 'number':
                                            switch (checkType?.name) {
                                                case "Retirement Age":
                                                    return <div className="form-group mt-3">
                                                        <label className='text-dark'>{checkType?.name}</label>
                                                        <input type="number" name={checkType?.name} className="form-control inputtext" required
                                                            onChange={(e) => {
                                                                const originalString = e.target.name;
                                                                const stringWithoutSpaces = originalString.split(' ').join('_');
                                                                setnumberInput({
                                        ...
                                        case 'checkbox':
                                            return <div className="form-group mt-3">
                                                ...
                                                <div className='form-control'>
                                                    <input type="Checkbox" name={checkType?.name} className="form-check-input inputtext" required
                                                        onChange={(e) => {
                                                            const originalString = e.target.name;
                                                            const stringWithoutSpaces = originalString.split(' ').join('_');
                                                            setCheckBoxInput({
                                        ...
                                        case 'month':
                                            return <div className="form-group mt-3">
                                                <label className='text-dark'>{checkType?.name}</label>
                                                <input type="Month" name={checkType?.name} className="form-control inputtext" required
                                                    onChange={(e) => {
                                                        const originalString = e.target.name;
                                                        const stringWithoutSpaces = originalString.split(' ').join('_');
                                                        setdateInput({
                                        ...
                                        case 'date':
                                            return <div className="form-group mt-3">
                                                <label className='text-dark'>{checkType?.name}</label>
                                                <input type="date" name={checkType?.name} className="form-control inputtext" required
                                                    onChange={(e) => {
                                                        const originalString = e.target.name;
                                                        const stringWithoutSpaces = originalString.split(' ').join('_');
                                                        setDateType({
