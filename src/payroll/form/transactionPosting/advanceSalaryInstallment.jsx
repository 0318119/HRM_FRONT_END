...
const OneTimeAllowanceForm = ({ getAllowanceList_Fixed,getDeductionEmployeeData, currentUser, getAllowanceDetail, saveAllowanceDetail, cancel, DeleteAllowanceDetail }) => {
            ...
            {loader ? <Skeleton active /> :
                <>
                    <div style={{ display: 'flex', alignItems: 'center' }}>
                        ...
                        <Select type={'loan'} label={'Select Allowance'} option={allowanceList} />
                    </div>
                    <>
