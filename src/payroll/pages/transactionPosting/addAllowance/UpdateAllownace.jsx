...
const UpdateAllownace = ({ getAllowanceList, UpdateLoansFunction, addNewFunction, update, GetUpdateData }) => {
...
export default connect(mapStateToProps, AddAllowance_Action)(UpdateAllownace);