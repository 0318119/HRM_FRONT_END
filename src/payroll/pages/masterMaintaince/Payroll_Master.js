...
import * as MasterPayroll from "../../../store/actions/payroll/masterPayroll/index";
...
function Payroll_Master({ cancel, isCode, page, Get_Master_Personal_By_Id, GetMasterPersonalData, Red_Master_Personal, mode }) {
...
export default connect(mapStateToProps, MasterPayroll)(Payroll_Master); 