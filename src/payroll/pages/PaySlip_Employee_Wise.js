...
import PaySlip_Employee_WiseForm from "../form/transactionPosting/PaySlip_Employee_WiseForm";
...
const PaySlip_Employee_Wise = ({ Red_Increment, GetIncrementOfAllEmployees }) => {
                ...
                <div className="row">
                    <div className="col-lg-12 maringClass">
                        {mode == "read" && (
                            <>
                                <div className="Base_CityFlexBox">
                                    <h4 className="text-dark">PaySlip (Employee Wise)</h4>
                        ...
                        <div>
                            ...
                            {mode == "Edit" && <PaySlip_Employee_WiseForm cancel={setMode} mode={mode} isCode={isCode} />}
                        </div>
                    </div>
                </div>
            </div>
...
export default connect(mapStateToProps, ACTIONS)(PaySlip_Employee_Wise);