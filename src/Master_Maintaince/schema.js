...
const MasterPersonal_schema = yup.object().shape({
  Emp_code: yup.number().required("Empployee code is required"),
  ...
  Emp_birth_date: yup.date().required("birth date is required"),
  Emp_Confirm_date: yup.date().required("Confirm date is required"),
  ...
  Emp_home_tel1: yup.number().required("Emp home tell 1 is required"),
  Emp_home_tel2: yup.number().required("Emp home tell 2 is required"),
  Emp_office_tel1: yup.number().required("office tel1 tel1 is required"),
  Emp_office_tel2: yup.number().required("office tel2 is required"),
  Emp_mobile_No: yup.string().required("Emp_mobile_No is required"),
  Emp_nic_no: yup.string().required("Emp_nic_no is required"),
  Emp_NIC_Issue_date: yup.date().required("Emp_NIC_Issue_date is required"),
  Emp_NIC_Expiry_date: yup.date().required("Emp_NIC_Expiry_date is required"),
  ...
  Contact_home_tel1: yup.number().required("Contact home tel1 is required"),
  Contact_home_tel2: yup.number().required("Contact_home_tel2 is required"),
  ...
  Offer_Letter_date: yup.date().required("Offer_Letter_date is required"),
  Tentative_Joining_date: yup.date().required("Tentative_Joining_date is required"),
  ...
  roster_group_code: yup.string().required("roster group code is required"),
