...
const MasterPersonal_schema = yup.object().shape({
  ...
  Emp_home_tel1: yup.string().required("Emp home tel1 is required"),
  Emp_home_tel2: yup.string().required("Emp home tel2 is required"),
  ...
  Emp_ntn_no: yup.string().required("Emp_ntn_no is required"),
  Emp_email: yup.string().required("Emp_email is required"),
  ...
  position_code: yup.string().required("position code is required"),
});
