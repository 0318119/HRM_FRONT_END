...
function ConfirmExtensionWaitingProcess() {
        ...
        <section className="confirmationSection">
            <div className="container-fluid p-0">
                <div className="TransactionConfirmation_listHeader">
                    <span className="">
                        Transaction Confirmation Extension Process - List
                    </span>
                </div>
                                        ...
                                        {isGetConfirmationData.map((items) => {
                                            return (
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button className="editBtnTable"><Link to={`/ConfirmationExtension?Process=Process&ConfirmExtenId=${items?.Emp_code}`} className="text-white">Process</Link></button>
                                                    </td>
                                                </tr>
                                            )
                                        })
...
export default ConfirmExtensionWaitingProcess;